...
INSERT INTO Product (name, broadType, clothingType, price, numStars, sku, image, manufacturer, height, length, width, weight, description, isNewArrival, saleId) VALUES ('Mens Tank Top', 'men', 'shirt', 30.00, 4.1, 'FB9764-246', 'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/f49bc6e0-1583-4a72-a080-2b6d908ea97e/sportswear-mens-tank-top-h9p5SP.png', 'Nike', 0.2, 40.00, 30.00, 0.4, 'Go sleeveless with the Swoosh. Soft cotton and ribbed trim keep you comfortable, wherever your journey takes you.', 1, 1);
--Mens Jackets
...
INSERT INTO Product (name, broadType, clothingType, price, numStars, sku, image, manufacturer, height, length, width, weight, description) VALUES ('BASIC STÜSSY PIGMENT DYED HOODIE', 'women', 'jacket', 130.00, 4.9, '1924879', 'https://cdn.shopify.com/s/files/1/0087/6193/3920/products/1924879_NATL_1_e323647a-d75b-4959-97f6-241e3fb94de0_grande.jpg?v=1683139136', 'Stüssy', 2.6, 27.5, 13.5, 118.64, 'Longsleeve pigment dyed hooded sweatshirt.');
--Womens Pants
...
INSERT INTO Product (name, broadType, clothingType, price, numStars, sku, image, manufacturer, height, length, width, weight, description, isNewArrival) VALUES ('Xersion Little & Big Boys Lightweight Track Jacket', 'kids', 'jacket', 36.49, 4, '4354868', 'https://jcpenney.scene7.com/is/image/JCPenney/DP0617202211312024M?hei=550&wid=550&op_usm=.4%2C.8%2C0%2C0&resmode=sharp2&op_sharpen=1', 'Xersion', 30, 25, .2, 5, 'Xersion track jacket.', 1);
...
INSERT INTO Product (name, broadType, clothingType, price, numStars, sku, image, manufacturer, height, length, width, weight, description, saleId) VALUES ('Miabella Italian 925 Sterling Silver 3.5mm Curb Cuban Link Chain Necklace', 'accessory', 'necklace', 21.90, 4.3, 'B0B6TP94X4', 'https://m.media-amazon.com/images/I/713tkhR-EvL._AC_UX679_.jpg', 'Miabella', 0.0, 20.00, 0.00, 1.0, 'Add style to a basic look with this solid 925 sterling silver 3.5mm Curb chain. Our flat diamond-cut beveled links offer a much more reflective look than the standard curb chain for an elegant rich shine. Strong, durable and comfortable, this slim version of the classic Cuban is perfect for all ages and for any occasion. Wear alone with a casual or formal outfit for everyday modern elegance, with your favorite pendant for a personal statement or as a great layering chain.', 3);
--Watches
...
INSERT INTO Product (name, broadType, clothingType, price, numStars, sku, image, manufacturer, height, length, width, weight, description, isNewArrival, saleId) VALUES ('NEW HERBIE! HUSKER BASEBALL HERBIE HERO CAP', 'accessory', 'hat', 29.99, 0.0, 'HT-G7152', 'https://www.bestofbigred.com/resize/Shared/Images/Product/NEW-HERBIE-Husker-Baseball-Herbie-Hero-Cap/HT-G7152.jpg?bw=1000&w=1000&bh=1000&h=1000', 'manufacturer', 13.48, 20.44, 16.58, 00.15, 'Scarlet EZA adjustable snapback hat. Features Herbie Husker with a baseball bat. 100% cotton twill. OSFA.', 1, 3);
...
INSERT INTO Sale (name, startDate, endDate, discount, isPercentDiscount) VALUES ('2023 April Fools!', '2023/04/01', '2024/04/01', 420.00, 0);
INSERT INTO Sale (name, startDate, endDate, discount, isPercentDiscount) VALUES ('250th Independence Day Sale', '2021/06/04', '2026/07/04', 10, 1);
