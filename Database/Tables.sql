...
--The following are current tables
...
INSERT INTO Product (name, broadType, clothingType, price, numStars, sku, image, manufacturer, height, length, width, weight, description) VALUES ('adidas Big Boys Lightweight Track Jacket', 'kids', 'jacket', 45, 4.5, '4353771', 'https://jcpenney.scene7.com/is/image/JCPenney/DP0531202109015022M?hei=550&wid=550&op_usm=.4%2C.8%2C0%2C0&resmode=sharp2&op_sharpen=1', 'adidas', 30, 25, .2, 5, 'Adidas track jacket.');
...
INSERT INTO Product (name, broadType, clothingType, price, numStars, sku, image, manufacturer, height, length, width, weight, description) VALUES ('Umbro Big Boys Lightweight Track Jacket', 'kids', 'jacket', 50, 0, '4356303', 'https://jcpenney.scene7.com/is/image/JCPenney/DP1202202207165740M?hei=550&wid=550&op_usm=.4%2C.8%2C0%2C0&resmode=sharp2&op_sharpen=1', 'Umbro', 30, 25, .2, 5, 'Umbro track jacket.');
--Kids Pants
...
--Kids Shorts
INSERT INTO Product (name, broadType, clothingType, price, numStars, sku, image, manufacturer, height, length, width, weight, description) VALUES ('Little & Big Boys Super Mario Pull-On Short', 'kids', 'shorts', 26, 5, '4121530', 'https://jcpenney.scene7.com/is/image/JCPenney/DP0323202307051620M?hei=550&wid=550&op_usm=.4%2C.8%2C0%2C0&resmode=sharp2&op_sharpen=1', 'Mario', 30, 25, .2, 5, 'Mario shorts.');
INSERT INTO Product (name, broadType, clothingType, price, numStars, sku, image, manufacturer, height, length, width, weight, description) VALUES ('Puma Big Boys Mid Rise Pull-On Short', 'kids', 'shorts', 28, 0, '4356052', 'https://jcpenney.scene7.com/is/image/JCPenney/DP0403202313052055M?hei=550&wid=550&op_usm=.4%2C.8%2C0%2C0&resmode=sharp2&op_sharpen=1', 'Puma', 30, 25, .2, 5, 'Puma shorts.');
...
INSERT INTO Product (name, broadType, clothingType, price, numStars, sku, image, manufacturer, height, length, width, weight, description) VALUES ('Balance Pull-On Big Boys Mid Rise Hybrid Short', 'kids', 'shorts', 26, 5, '4356030', 'https://jcpenney.scene7.com/is/image/JCPenney/DP0117202307221850M?hei=550&wid=550&op_usm=.4%2C.8%2C0%2C0&resmode=sharp2&op_sharpen=1', 'Balance', 30, 25, .2, 5, 'Balance red shorts.');
--Backpacks
...
INSERT INTO SaleProduct (saleId, productId) VALUES ((SELECT saleId FROM Sale WHERE name = '2023 April Fools!'), (SELECT productId FROM Product WHERE name = 'Diamond Halo 18" Pendant Necklace (3/4 ct. t.w.) in 14k White, Yellow or Rose Gold'));
INSERT INTO SaleProduct (saleId, productId) VALUES ((SELECT saleId FROM Sale WHERE name = '250th Independence Day Sale'), (SELECT productId FROM Product WHERE name = 'Mens Tank Top'));
INSERT INTO SaleProduct (saleId, productId) VALUES ((SELECT saleId FROM Sale WHERE name = '250th Independence Day Sale'), (SELECT productId FROM Product WHERE name = 'Miabella Italian 925 Sterling Silver 3.5mm Curb Cuban Link Chain Necklace'));
INSERT INTO SaleProduct (saleId, productId) VALUES ((SELECT saleId FROM Sale WHERE name = '250th Independence Day Sale'), (SELECT productId FROM Product WHERE name = 'GG velvet shorts'));
INSERT INTO SaleProduct (saleId, productId) VALUES ((SELECT saleId FROM Sale WHERE name = 'Back to school sale!'), (SELECT productId FROM Product WHERE name = 'CLASSIC 3-STRIPES BACKPACK'));
INSERT INTO SaleProduct (saleId, productId) VALUES ((SELECT saleId FROM Sale WHERE name = 'Back to school sale!'), (SELECT productId FROM Product WHERE name = 'CREATOR BACKPACK'));
INSERT INTO SaleProduct (saleId, productId) VALUES ((SELECT saleId FROM Sale WHERE name = 'Back to school sale!'), (SELECT productId FROM Product WHERE name = 'Nike Sportswear RPM'));
INSERT INTO SaleProduct (saleId, productId) VALUES ((SELECT saleId FROM Sale WHERE name = 'Back to school sale!'), (SELECT productId FROM Product WHERE name = 'Nike Hoops Elite Pro'));
