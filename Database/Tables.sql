...
--INSERT INTO Product (name, price, broadType, clothingType, image, manufacturer, numStars, sku, height, length, width, weight, description) VALUES 
--('Button-Up', 14.99, 'men', 'shirt', 'IMAGE HERE', 'Professional Co.', 4.58, 'WAT15SKU', 5.00, 10.00, 8.00, 0.45, 'c');
--INSERT INTO Product (name, price, broadType, clothingType, image, manufacturer, numStars, sku, height, length, width, weight, description) VALUES 
--('Pride Coat', 18.99, 'adults', 'jacket', 'IMAGE HERE', 'Spencers Inc.', 4.12, 'NCJSH523', 7.00, 18.00, 16.00, 2.03, 'c');
--INSERT INTO Product (name, price, broadType, clothingType, image, manufacturer, numStars, sku, height, length, width, weight, description) VALUES 
--('American-Made Long Johns', 24.99, 'women', 'pants', 'IMAGE HERE', 'Long Johns Corps', 3.68, 'MKCJS138', 6.40, 16.80, 16.60, 1.77, 'c');
--INSERT INTO Product (name, price, broadType, clothingType, image, manufacturer, numStars, sku, height, length, width, weight, description) VALUES 
--('Sweatpants', 22.74, 'kids', 'pants', 'IMAGE HERE', 'New Fashion Inc.', 3.57, 'IH8B33RS', 4.00, 10.00, 10.00, 0.98, 'c');
--INSERT INTO Product (name, price, broadType, clothingType, image, manufacturer, numStars, sku, height, length, width, weight, description) VALUES 
--('Running Shorts', 10.99, 'men', 'shorts', 'IMAGE HERE', 'Athletic Co.', 3.76, 'NBR11167', 3.00, 8.00, 8.00, 0.26, 'c');
--INSERT INTO Product (name, price, broadType, clothingType, image, manufacturer, numStars, sku, height, length, width, weight, description) VALUES 
--('Lounging Shorts', 12.99, 'women', 'shorts', 'IMAGE HERE', 'Relax Co.', 3.31, 'LOV12224', 5.00, 8.00, 7.00, 0.50, 'c');
--INSERT INTO Product (name, price, broadType, clothingType, image, manufacturer, numStars, sku, height, length, width, weight, description) VALUES 
--('Socks for kids', 8.50, 'kids', 'socks', 'IMAGE HERE', 'New Fashion Inc.', 4.24, 'XXVHG234', 4.80, 10.90, 10.10, 1.26, 'c');
--INSERT INTO Product (name, price, broadType, clothingType, image, manufacturer, sku, height, length, width, weight, description) VALUES
--('B33R HELMET', 15.99, 'adults', 'hat', 'IMAGE HERE', 'Have Fun Co.', 'BEER4LYF', 24.50, 32.50, 32.50, 4.20, 'c');
--INSERT INTO Product (name, price, broadType, clothingType, image, manufacturer, sku, height, length, width, weight, description) VALUES 
--('Husker Baseball Cap', 19.99, 'everybody', 'hat', 'IMAGE HERE', 'Athletic Co.', 'MLB13233', 11.31, 15.16, 11.65, 0.75, 'c');
