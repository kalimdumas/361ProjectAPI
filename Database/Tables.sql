...
INSERT INTO Product (name, broadType, clothingType, price, numStars, sku, image, manufacturer, height, length, width, weight, description, isNewArrival) VALUES ('Mens Tank Top', 'men', 'shirt', 30.00, 4.1, 'FB9764-246', 'https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/f49bc6e0-1583-4a72-a080-2b6d908ea97e/sportswear-mens-tank-top-h9p5SP.png', 'Nike', 0.2, 40.00, 30.00, 0.4, 'Go sleeveless with the Swoosh. Soft cotton and ribbed trim keep you comfortable, wherever your journey takes you.', TRUE);
--Mens Jackets
